  ...
  return (
    <div className="mx-auto max-w-lg space-y-7">
      ...
      <div className="rounded-2xl border border-night-900/10 bg-white p-4 shadow-card sm:p-5">
        ...
        <ul className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-1.5 text-xs font-medium text-night-700/65">
          <LegendItem className="bg-emerald-500" label="Completed" />
          <LegendItem className="bg-brand-600" label="Current" />
          <LegendItem className="bg-night-900/25" label="Locked" />
        </ul>
      </div>
