...
import { denomVars, type ChipDenom } from './chipDenoms'
...
//
// The denomination data + helpers live in ./chipDenoms (so this file only exports
// React components). ChipDisc renders a single face-on denominated disc, reused by
// the lesson pot pile and the casino table's chip-flight animation.

/**
 * A single, face-on poker chip — a domed disc with the classic ring of edge spots
 * and an optional center denomination. Used for the lesson pot pile and for the
 * chips in flight on the casino table. `denom` picks the color; `label` shows the
 * value (skipped when too small).
 */
