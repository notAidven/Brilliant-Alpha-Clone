...
export const skillCheckAdvImplied: SkillCheckDefinition = {
  ...
  questions: [
    ...
    },
    {
      ...
      showCalculator: true,
      prompt:
        'Flop flush draw, about 35% to hit by the river. The pot is 90 and it costs 30 to call. Using EV = (win chance) x (pot) - (lose chance) x (call), what is the EV of calling, in chips?',
      interaction: 'betting-round',
      config: {
        hole: ['AH', 'KH'],
        board: ['QH', '7H', '2C'],
        ...
        seed: 462,
        task: 'ev-of-call',
        helperText: 'There is 90 in the pot and it costs 30 to call. Your flush draw is about 35% to hit.',
      },
      answer: { evChips: 12, evTolerance: 1 },
      incorrectFeedback:
        'EV = 0.35 x 90 - 0.65 x 30 = 31.5 - 19.5 = +12 chips, a profitable call even before implied odds.',
    },
  ],
}
