    ...
    },
    {
      ...
      feedback: {
        ...
        hints: [
          ...
          'Put your numbers into the formula: $\\frac{20}{100 + 20}$.',
        ],
...
That single comparison is the whole decision.`,
    ...
    },
    {
      ...
      feedback: {
        ...
        hints: [
          ...
          'The draw has not changed, so recall its turn equity from the Rule of 2.',
          'Compare your equity to the price: call when your equity is at least the price.',
        ],
    ...
    },
    {
      ...
      feedback: {
        ...
        hints: [
          'Count your flush outs (the suit cards you cannot see), then use the Rule of 2 for turn equity.',
